...
export function GripVertical({ size = 24, onClickFn, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      strokeLinejoin="round"
      onClick={onClickFn}
      className={`icon icon-tabler icons-tabler-outline icon-tabler-grip-vertical ${className}`}
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export function Trash({ size = 24, onClickFn, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
